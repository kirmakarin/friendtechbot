...
const TWITTER_SCOUT_PERFECT_SCORE = 750; // Adjust this number as per your requirement.
...
const run = async () => {
  ...
  friends.on(filter, async (event) => {
    ...
    if (details.isBuy && isNewAccount(details)) {
      ...
      if (weiBalance > 95000000000000000 && weiBalance < 105000000000000000)
        return;
